...
- (void)awakeFromNib {
    ...
    self.btnClearAll.layer.cornerRadius = 30;
    ...
    [_momentGraph addVerticalLabel:@[@"2100",@"2300",@"2500",@"2700",@"2900",@"3100",@"3300",@"3500",@"3700"]];
    [self addSubview:_momentGraph];
...
- (void)drawGraph
{
    ...
    if ([[(UITextField *)[self viewWithTag:211] text]doubleValue] > 0 && [[(UITextField *)[self viewWithTag:271] text] doubleValue] > 0) {
        [arrayMinGraph addObject:[NSString stringWithFormat:@"%@:%@", [(UITextField *)[self viewWithTag:211] text],[(UITextField *)[self viewWithTag:271] text]]];
    }
    
    if ([[(UITextField *)[self viewWithTag:221] text] doubleValue] > 0 && [[(UITextField *)[self viewWithTag:291] text] doubleValue] > 0) {
        [arrayMinGraph addObject:[NSString stringWithFormat:@"%@:%@", [(UITextField *)[self viewWithTag:221] text],[(UITextField *)[self viewWithTag:281] text]]];
    }
    
    if ([[(UITextField *)[self viewWithTag:241] text] doubleValue] > 0 && [[(UITextField *)[self viewWithTag:291] text]doubleValue] > 0) {
        [arrayMinGraph addObject:[NSString stringWithFormat:@"%@:%@", [(UITextField *)[self viewWithTag:241] text],[(UITextField *)[self viewWithTag:291] text]]];
    }
    if ([[(UITextField *)[self viewWithTag:101] text]doubleValue] > 0 && [[(UITextField *)[self viewWithTag:301] text]doubleValue] > 0) {
        [arrayMinGraph addObject:[NSString stringWithFormat:@"%@:%@", [(UITextField *)[self viewWithTag:101] text],[(UITextField *)[self viewWithTag:301] text]]];
    }
    ...
    if ([[(UITextField *)[self viewWithTag:211] text]doubleValue] > 0 && [[(UITextField *)[self viewWithTag:311] text] doubleValue] > 0) {
        [arrayMinGraph addObject:[NSString stringWithFormat:@"%@:%@", [(UITextField *)[self viewWithTag:211] text],[(UITextField *)[self viewWithTag:311] text]]];
    }
    
    if ([[(UITextField *)[self viewWithTag:221] text] doubleValue] > 0 && [[(UITextField *)[self viewWithTag:321] text] doubleValue] > 0) {
        [arrayMinGraph addObject:[NSString stringWithFormat:@"%@:%@", [(UITextField *)[self viewWithTag:221] text],[(UITextField *)[self viewWithTag:321] text]]];
    }
    
    if ([[(UITextField *)[self viewWithTag:241] text] doubleValue] > 0 && [[(UITextField *)[self viewWithTag:331] text]doubleValue] > 0) {
        [arrayMinGraph addObject:[NSString stringWithFormat:@"%@:%@", [(UITextField *)[self viewWithTag:241] text],[(UITextField *)[self viewWithTag:331] text]]];
    }
    if ([[(UITextField *)[self viewWithTag:101] text]doubleValue] > 0 && [[(UITextField *)[self viewWithTag:341] text]doubleValue] > 0) {
        [arrayMinGraph addObject:[NSString stringWithFormat:@"%@:%@", [(UITextField *)[self viewWithTag:101] text],[(UITextField *)[self viewWithTag:341] text]]];
    }
    ...
    if ([[(UITextField *)[self viewWithTag:211] text]doubleValue] > 0 && [[(UITextField *)[self viewWithTag:272] text]doubleValue] > 0) {
        [arrayMaxGraph addObject:[NSString stringWithFormat:@"%@:%@", [(UITextField *)[self viewWithTag:211] text],[(UITextField *)[self viewWithTag:272] text]]];
    }
    
    if ([[(UITextField *)[self viewWithTag:221] text]doubleValue] > 0 && [[(UITextField *)[self viewWithTag:282] text]doubleValue] > 0) {
        [arrayMaxGraph addObject:[NSString stringWithFormat:@"%@:%@", [(UITextField *)[self viewWithTag:221] text],[(UITextField *)[self viewWithTag:282] text]]];
    }
    if ([[(UITextField *)[self viewWithTag:241] text]doubleValue] > 0 && [[(UITextField *)[self viewWithTag:292] text]doubleValue] > 0) {
        [arrayMaxGraph addObject:[NSString stringWithFormat:@"%@:%@", [(UITextField *)[self viewWithTag:241] text],[(UITextField *)[self viewWithTag:292] text]]];
    }
    if ([[(UITextField *)[self viewWithTag:101] text]doubleValue] > 0 && [[(UITextField *)[self viewWithTag:302] text]doubleValue] > 0) {
        [arrayMaxGraph addObject:[NSString stringWithFormat:@"%@:%@", [(UITextField *)[self viewWithTag:101] text],[(UITextField *)[self viewWithTag:302] text]]];
    }
    
    
    /** Utility Max **/
    if ([[(UITextField *)[self viewWithTag:211] text]doubleValue] > 0 && [[(UITextField *)[self viewWithTag:312] text]doubleValue] > 0) {
        [arrayMaxGraph addObject:[NSString stringWithFormat:@"%@:%@", [(UITextField *)[self viewWithTag:211] text],[(UITextField *)[self viewWithTag:312] text]]];
    }
    
    if ([[(UITextField *)[self viewWithTag:221] text]doubleValue] > 0 && [[(UITextField *)[self viewWithTag:322] text]doubleValue] > 0) {
        [arrayMaxGraph addObject:[NSString stringWithFormat:@"%@:%@", [(UITextField *)[self viewWithTag:221] text],[(UITextField *)[self viewWithTag:322] text]]];
    }
    if ([[(UITextField *)[self viewWithTag:241] text]doubleValue] > 0 && [[(UITextField *)[self viewWithTag:332] text] doubleValue]> 0) {
        [arrayMaxGraph addObject:[NSString stringWithFormat:@"%@:%@", [(UITextField *)[self viewWithTag:241] text],[(UITextField *)[self viewWithTag:332] text]]];
    }
    if ([[(UITextField *)[self viewWithTag:101] text]doubleValue] > 0 && [[(UITextField *)[self viewWithTag:342] text]doubleValue] > 0) {
        [arrayMaxGraph addObject:[NSString stringWithFormat:@"%@:%@", [(UITextField *)[self viewWithTag:101] text],[(UITextField *)[self viewWithTag:342] text]]];
    }
    ...
    if ([[(UITextField *)[self viewWithTag:171] text]doubleValue] > 0 && [[(UITextField *)[self viewWithTag:172] text]doubleValue] > 0) {
        [arrayRedGraph addObject:[NSString stringWithFormat:@"%@:%@", [(UITextField *)[self viewWithTag:171] text],[(UITextField *)[self viewWithTag:172] text]]];
    }
    
    if ([[(UITextField *)[self viewWithTag:201] text]doubleValue] > 0 && [[(UITextField *)[self viewWithTag:202] text]doubleValue] > 0) {
        [arrayRedGraph addObject:[NSString stringWithFormat:@"%@:%@", [(UITextField *)[self viewWithTag:201] text],[(UITextField *)[self viewWithTag:202] text]]];
    }
    if (arrayRedGraph.count > 0) {
        [_momentGraph drawGraph:arrayRedGraph color:[UIColor redColor] shapeLayer:self.shapeLayerGraphLine];
    }
}
...
-(void)deleteFile:(WeightBalance*)balance {
    ...
    [appDelegate.managedObjectContext deleteObject:balance];
    NSError *error;
